...
INSERT INTO `journal` VALUES (1,1,3,2),(2,2,4,1),(3,3,5,2),(4,4,6,2),(5,5,7,2),(6,6,8,1),(7,7,9,2),(8,8,10,2),(9,9,11,2),(10,10,12,1),(11,11,13,1),(12,12,15,2),(13,13,16,1),(14,14,17,2),(15,15,29,1),(16,16,30,1),(17,17,31,2),(18,18,32,1),(19,19,33,2),(20,20,34,1),(21,21,35,1),(22,22,36,2),(23,23,37,2),(24,24,38,2),(25,25,39,2),(26,26,40,2),(27,27,41,2),(28,28,42,2),(29,29,43,1),(30,30,44,2),(31,31,45,1),(32,32,46,1),(33,33,47,1),(34,34,48,1),(35,35,49,2),(36,36,50,1),(37,37,51,1),(38,38,52,2),(39,39,53,2),(40,40,54,2),(41,41,55,1),(42,42,56,1),(43,43,57,2);
...
INSERT INTO `protocol` VALUES (1,1,271,'Есть дефект на устройстве не сказывающися в его работе',8),(2,2,271,'',11),(3,3,351,'Есть дефект на самом устройстве но не влияющий на работу устройства',10),(4,4,350,'При измерении выдает ошибку',10),(5,5,349,'Есть дефект не влияющий на работу устройства',10),(15,15,291,'',8),(16,16,271,'',8),(17,17,359,'Все хорошо',5),(19,6,271,'Я пытался',5),(20,7,271,'Я очень старался',5),(21,8,271,'Аниме девочки лучшие',8),(22,9,365,'ывывв',8),(23,10,385,'Все норм',5),(24,11,363,'eereee',8),(25,12,382,'',12),(26,13,382,'',11),(27,14,382,'',10),(28,15,382,'',11),(29,16,329,'hello',8),(30,17,290,'',10),(31,18,283,'[t[t[',8),(32,19,350,'',9),(33,20,293,'hjhj',9),(34,21,281,'ddfd',10),(35,22,324,'',9),(36,23,324,'',5),(37,24,324,'',10),(38,25,326,'fdfdf',10),(39,26,326,'',11);
...
BEGIN
	...
	JOIN `oborot_si`.`department` dep on `mes_ins`.`id_department` = `dep`.`id_department` 
...
GROUP BY 
`journal`.`id_journal`
ORDER BY `name_instrument`.`name_instrument`;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetScheduleArchive` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`OborotSiAdmin`@`%` PROCEDURE `GetScheduleArchive`()
BEGIN
	SELECT 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetScheduleArchiveByData` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`OborotSiAdmin`@`%` PROCEDURE `GetScheduleArchiveByData`(in nextDate date)
BEGIN
	SELECT 
		`schedule`.`id_schedule`, 
		`name_instrument`.`name_instrument`, 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetScheduleArchiveByInventoryFactory` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`OborotSiAdmin`@`%` PROCEDURE `GetScheduleArchiveByInventoryFactory`(in inventory_num varchar(50), in factory_num varchar(50))
BEGIN
	SELECT 
		`schedule`.`id_schedule`, 
		`name_instrument`.`name_instrument`, 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetScheduleByData` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`OborotSiAdmin`@`%` PROCEDURE `GetScheduleByData`(in nextDate date)
BEGIN
	SELECT 
		`schedule`.`id_schedule`, 
		`name_instrument`.`name_instrument`, 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetScheduleByNextData` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`OborotSiAdmin`@`%` PROCEDURE `GetScheduleByNextData`(in nextDate date)
BEGIN
	SELECT 
		`schedule`.`id_schedule`, 
		`name_instrument`.`name_instrument`, 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetScheduleByNextDataFilter` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`OborotSiAdmin`@`%` PROCEDURE `GetScheduleByNextDataFilter`(in nextDate date)
BEGIN
	SELECT 
		`schedule`.`id_schedule`, 
		`name_instrument`.`name_instrument`, 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetScheduleDataByInventoryFactoryNumbers` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`OborotSiAdmin`@`%` PROCEDURE `GetScheduleDataByInventoryFactoryNumbers`(in nextDate date, in inventory_num varchar(50), in factory_num varchar(50))
BEGIN
	SELECT 
        `schedule`.`id_schedule`,
		`name_instrument`.`name_instrument`, 
...
-- Dump completed on 2023-05-05 16:30:10
