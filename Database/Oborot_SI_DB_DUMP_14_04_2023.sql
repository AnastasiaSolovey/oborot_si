...
CREATE TABLE `belong_to` (
  `id_belong_to` int NOT NULL AUTO_INCREMENT,
  `belong_to` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id_belong_to`),
  UNIQUE KEY `belong_to_UNIQUE` (`belong_to`)
...
INSERT INTO `belong_to` VALUES (1,'Отдел 117'),(2,'Отдел 131'),(3,'Отдел 65'),(4,'Цех № 10'),(5,'Цех № 9');
...
INSERT INTO `employee_data` VALUES (1,5,'2021-06-14','qwerty111','601f754297eecd60d2f5','f937268c7e2788ed320c',1,_binary ''),(2,8,'2018-01-21','qwerty222','9340f19a3a4dda4b98d5','195f62edd40a1d9b0c6407104596d6c29e2b408ecc1cc964e803376917ab1fd0',2,_binary '');
...
INSERT INTO `journal` VALUES (1,'2007-12-20',271,1,1),(2,'2007-12-20',271,1,2),(3,'2006-12-20',274,2,1),(4,'2007-12-20',274,1,2),(5,'2007-12-20',286,1,1),(6,'2009-12-20',349,2,2),(7,'2009-12-20',350,2,2),(8,'2009-12-20',351,1,2),(9,'2024-12-20',330,1,3),(10,'2024-12-20',330,1,1),(11,'2024-12-20',330,2,1),(12,'2023-03-29',357,2,2),(13,'2023-03-25',357,2,1),(14,'2023-03-17',357,2,3),(15,'2023-03-29',291,1,3),(16,'2023-03-29',271,1,1),(17,'2023-04-01',359,1,1);
...
CREATE TABLE `measuring_instrument` (
  ...
  `id_belong_to` int NOT NULL,
  PRIMARY KEY (`id_measuring_instrument`),
  KEY `FK_si_card_sostoyanie` (`id_condition`),
  KEY `FK_si_card_prinadlejnost` (`id_belong_to`),
  KEY `id_name_instrument_idx` (`id_name_instrument`),
  CONSTRAINT `id_belong_to` FOREIGN KEY (`id_belong_to`) REFERENCES `belong_to` (`id_belong_to`) ON UPDATE CASCADE,
...
-- Dump completed on 2023-04-14 15:47:52
